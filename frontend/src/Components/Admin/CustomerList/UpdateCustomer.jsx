...
function UpdateCustomerForm({ customer, onClose, onSuccess }) {
    ...
    customerService
      ...
      .then((data) => {
        if (data.error) {
          ...
          setSuccess(true);
          setServerError("");
          // Pass the updated customer data back to the parent component
          onSuccess({
            ...customer,
            customer_email,
            customer_first_name,
  ...
  return (
    <Form onSubmit={handleSubmit} className="px-4 border rounded bg-light my-auto">
      <Row>
        <Col md={6}>
        ...
        <Col md={6}>
          ...
          <Form.Group controlId="formActive">
            ...
            <Form.Control
              ...
              onChange={(event) =>
                setActive_customer(Number(event.target.value))
              }
            >
