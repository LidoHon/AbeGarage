...
// // Update a service
// router.put('/api/services/:id', authMiddleware.verifyToken, authMiddleware.isAdmin, serviceController.updateService);

// // Delete a service
// router.delete('/api/services/:id', authMiddleware.verifyToken, authMiddleware.isAdmin, serviceController.deleteService);
